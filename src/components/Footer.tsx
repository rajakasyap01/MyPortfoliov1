  ...
  return (
    <footer className="relative bg-secondary py-12 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-0 w-72 h-72 bg-primary/5 rounded-full blur-3xl animate-pulse-glow"></div>
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-accent/5 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-secondary-foreground font-heading">RAJA KUMAR</h2>
            </div>
            <p className="text-secondary-foreground/80 mt-2 max-w-md">
              Crafting innovative digital solutions with modern web technologies. Let's build something amazing together.
            </p>
          </motion.div>
